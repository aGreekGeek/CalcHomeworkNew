...
implemented in the calculator.operations module,
as well as the functionality of the Calculation
class that encapsulates these operations.
"""
...
# Import the Calculation class from the calculator
# package to test its functionality.
# Import the arithmetic operation functions
# (add, subtract, multiply, divide) to be tested.
...
# with different sets of arguments. Here, it's used to test various scenarios
# of arithmetic operations
# with both integer and decimal operands to ensure the
# operations work correctly under different conditions.
...
def test_calculation_operations(a, b, operation, expected):
    ...
    This test ensures that the Calculation
    class correctly performs the arithmetic operation
    (specified by the 'operation' parameter)
    on two Decimal operands ('a' and 'b'),
    ...
    assert calc.perform() == expected, f"Failed {operation.__name__} operation with {a} and {b}"
     # Perform the operation and assert that the result
...
def test_divide_by_zero():
    ...
    correctly raises a ValueError, as dividing by zero is
    mathematically undefined and should be handled as an error.
    """
